...
function getResourceUrl(req) {
  ...
  const path = String(req.url || "/api/construction/rc-pour-readiness-live");
...
export default async function handler(req, res) {
  ...
  try {
    ...
    console.error("x402 mainnet verify unavailable", error);
  ...
  try {
    ...
    console.error("x402 mainnet settle unavailable", error);
